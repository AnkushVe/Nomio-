        ...
        <div className="grid grid-cols-12 gap-8 h-[calc(100vh-200px)]">
          ...
          <div className="col-span-4">
            <div className="bg-white rounded-3xl shadow-xl border border-gray-200/50 flex flex-col h-full">
              <div className="h-16 bg-gradient-to-r from-purple-50 to-pink-50 border-b border-gray-200/50 flex items-center px-6">
                <div className="flex items-center space-x-3">
              ...
              <div className="p-6 border-t border-gray-200/50 bg-gray-50/50">
                ...
                <div className="flex space-x-3">
                  <input
                    ...
                    placeholder="Type or use voice to ask about destinations..."
                    className="flex-1 px-4 py-3 bg-white border border-gray-200 rounded-2xl text-slate-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm"
                  />
                  <button
                    onClick={handleSendMessage}
                    className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl hover:from-blue-600 hover:to-indigo-700 transition-all text-sm font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
                    Send
                  </button>
                </div>
